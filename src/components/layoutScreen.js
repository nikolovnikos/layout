...
const LayoutScreenConverter = ({
  ...
  const dimensions = useMemo(() => {
    ...
    const getMobileDimensions = (s = stylesZ) => {
    ...
    const getDesktopDimensions = (s = stylesZ) => {
    ...
    const getTabletDimensions = (s = stylesZ) => {
    ...
    switch (deviceType) {
      case 'mobile':
        dimensions = getMobileDimensions(stylesZ);
        break;
      case 'desktop':
        dimensions = getDesktopDimensions(stylesZ);
        break;
      case 'tablet':
        dimensions = getTabletDimensions(stylesZ);
        break;
      default:
        dimensions = getMobileDimensions();
        break;
    }
    return dimensions;
  }, [orientation, resize]);
